...
```text
├── ML_Project_Final.ipynb               # Main Jupyter Notebook containing all codes
├── ML_Project_Report_Final.pdf          # Detailed Project Report
├── dataset.csv                          # Classification Dataset
├── spotify_data clean.csv               # Regression Dataset
├── Most Streamed Spotify Songs 2024.csv # Clustering Dataset
├── m_l_png/                             # Generated plots and visualizations
